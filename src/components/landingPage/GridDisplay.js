...
export const GridDisplay = () => {
    return (
        <section className="bg-gray-50">
            <div className="container mx-auto font-poppins px-2 lg:px-20 xl:px-40 py-10 md:py-20">
                <div className="flex flex-col md:flex-row justify-between gap-5">
                    ...
                    <div className="flex flex-col h-full w-full">
                        ...
                        <p className="text-sm lg:text-base">
                            We care for your body and our programs are built to help you get to the best shape of your life through:
                        </p>
                        ...
                        <div className="flex gap-2 font-bold text-blue-600 my-10 tracking-wide w-full justify-between md:hidden">
                            <p className="mb-1 flex items-center w-full relative">
                            ...
                            <p className="mb-1 flex items-center relative">
                                <i className="fa-solid fa-circle text-sm me-1 animate-pulse"></i>
