...
export const Pricing = () => {
    return (
        <section className="my-10 lg:my-20 overflow-auto">
            {/* Header */}
            <div className="container mx-auto font-poppins px-2 lg:px-20 xl:px-40">
                <div className="mb-3 sm:mb-5">
                    ...
                    <h2 className="text-xl sm:text-2xl lg:text-4xl font-bold">Packages</h2>
                </div>
            </div>
            {/* Pricing */}
            <div className="container mx-auto font-poppins lg:px-20 xl:px-40">
                <div className="grid grid-cols-3 gap-2 xl:gap-5 overflow-visible w-max md:w-full px-2 lg:px-0">
                    ...
                    <div className="border rounded-md p-3 md:p-5 w-full bg-gray-50">
                        ...
                        <a href="#" className="block mx-auto w-fit px-3 py-2 lg:px-4 lg:py-3 border-2 border-black hover:bg-lime-400 hover:border-lime-400 rounded-sm lg:text-lg font-semibold mt-5">
