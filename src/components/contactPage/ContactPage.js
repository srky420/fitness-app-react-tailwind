        ...
        <div className="container mx-auto font-poppins px-2 lg:px-20 xl:px-40 mt-5 lg:mt-10 mb-20 lg:mb-40">
            ...
            <div className="mb-5 lg:mb-10 flex flex-col md:flex-row gap-10 justify-between">
                <div className="flex flex-col gap-2 w-full text-sm 2xl:text-base">
                    ...
                    {/* Socials */}
                    <div className="flex gap-2 border-t pt-5 mt-3 items-center">
                        <p className="font-bold me-1">Socials:</p>
                        <ul className="flex gap-2 text-sm lg:text-base w-fit mx-auto md:mx-0">
                            <li>
                ...
                {/* Send Message */}
                <form className="grid grid-cols-2 p-10 bg-gray-50 rounded-sm gap-2 lg:gap-5 w-full text-sm 2xl:text-base">
                    <h2 className="text-xl sm:text-2xl 2xl:text-4xl font-bold col-span-2">Send Us a Message</h2>
